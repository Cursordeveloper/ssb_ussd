...
final class PolicyContentTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table(table: 'policy_contents')->insert([
            ...
            ['policy_id' => 3, 'text' => 'SusuBox provides seamless transactions, enables easy monitoring of account and building trust.'],

            ['policy_id' => 3, 'text' => 'Personal Susu: Customers create a daily savings amount and links mobile money wallet to it.'],
            ['policy_id' => 3, 'text' => 'Personal Susu: SusuBox auto-deducts daily savings from the customer’s linked wallet for 31 days.'],
            ['policy_id' => 3, 'text' => 'Personal Susu: After 31 days, customers can withdraw or retain their savings.'],
            ['policy_id' => 3, 'text' => 'Personal Susu: Retained savings build creditworthiness for loans.'],
            ['policy_id' => 3, 'text' => 'Personal Susu: New cycle is automatically restarted as soon as previous cycle completed.'],
