...
final class PolicyContentTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table(table: 'policy_contents')->insert([
            ...
            ['policy_id' => 2, 'text' => 'SusuBox provides digital savings and investment services, allowing users to set goals and contribute funds online.'],
            ['policy_id' => 2, 'text' => 'Customers can make contributions via mobile money or other payment methods, and access investment and educational resources.'],
            ...
            ['policy_id' => 2, 'text' => 'Agreement to SusuBox terms and conditions, privacy policy, and other applicable agreements is mandatory for all customers.'],
            ...
            ['policy_id' => 2, 'text' => 'Contributions for savings are automatically deducted from the linked mobile or bank account based on the selected frequency.'],
