...
final class MyInsuranceAccountsState
{
    public static function execute(Session $session, $service_data): JsonResponse
    {
        ...
        if ($service_data->user_input === '0') {
            return ReturnToServiceAction::execute(session: $session, service_data: $service_data, service: 'insurance');
        }
        ...
        if (array_key_exists(key: $service_data->user_input, array: $user_data['insurance_accounts'])) {
