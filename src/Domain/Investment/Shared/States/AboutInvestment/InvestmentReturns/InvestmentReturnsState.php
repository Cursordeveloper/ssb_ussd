...
namespace Domain\Investment\Shared\States\AboutInvestment\InvestmentReturns;
...
final class InvestmentReturnsState
{
    public static function execute(Session $session, $service_data): JsonResponse
    {
        ...
        if ($service_data->user_input === '#') {
            ...
            return InvestmentReturnsMenu::nextContentMenu(session: $session);
        }

        // Return the invalidChoiceMenu
        return InvestmentReturnsMenu::invalidChoiceMenu(session: $session);
    }
}
