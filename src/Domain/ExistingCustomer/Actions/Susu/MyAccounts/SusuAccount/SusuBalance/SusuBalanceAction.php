...
final class SusuBalanceAction
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        $balance = (new SusuServiceSusuBalanceRequest)->execute(
            customer: $customer,
        ...
        if (! empty(data_get($balance, key: 'data'))) {
            return SusuAccountBalanceMenu::susuBalanceMenu(session: $session, susu_data: data_get(target: $balance, key: 'data.attributes'));
        }
