...
use App\Services\Susu\Requests\BizSusu\ApproveBizSusu;
...
final class ConfirmationAction
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        $susu_approved = (new ApproveBizSusu)->approveBizSusu(customer: $customer, data: PinApprovalData::toArray($session_data->user_input), susu_resource: $user_data['susu_resource']);
