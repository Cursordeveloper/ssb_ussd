...
final class ConfirmNewPinAction
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        $pin_changed = (new CustomerService)->changePin(customer: $customer, data: ['data' => PinChangeDTO::toArray(current_pin: data_get(target: $data, key: 'current_pin'), new_pin: data_get(target: $data, key: 'new_pin'))]);
