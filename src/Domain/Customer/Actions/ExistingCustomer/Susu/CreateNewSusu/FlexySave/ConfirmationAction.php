...
final class ConfirmationAction
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        $susu_approved = (new ApproveFlexySusu)->execute(customer: $customer, data: PinApprovalDTO::toArray($session_data->user_input), susu_resource: $user_data['susu_resource']);
