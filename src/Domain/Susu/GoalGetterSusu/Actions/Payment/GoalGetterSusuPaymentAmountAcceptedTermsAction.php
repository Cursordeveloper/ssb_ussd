...
final class GoalGetterSusuPaymentAmountAcceptedTermsAction
{
    ...
    {
        // Execute the SusuServiceGoalGetterSusuPaymentAmountRequest HTTP request
        $response = (new SusuServiceGoalGetterSusuPaymentAmountRequest)->execute(
            customer: $session->customer,
            data: SusuServiceGoalGetterSusuPaymentAmountData::toArray(user_inputs: $session->userInputs()),
