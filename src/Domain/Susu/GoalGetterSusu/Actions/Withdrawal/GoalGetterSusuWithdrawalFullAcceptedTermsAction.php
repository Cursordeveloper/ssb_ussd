...
final class GoalGetterSusuWithdrawalFullAcceptedTermsAction
{
    ...
    {
        // Execute the SusuServiceGoalGetterSusuWithdrawalFullRequest HTTP request
        $response = (new SusuServiceGoalGetterSusuWithdrawalFullRequest)->execute(
            customer: $session->customer,
            data: SusuServiceGoalGetterSusuWithdrawalFullData::toArray(user_inputs: $session->userInputs()),
