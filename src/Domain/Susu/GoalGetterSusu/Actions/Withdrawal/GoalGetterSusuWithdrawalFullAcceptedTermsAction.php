...
use App\Services\Susu\Data\GoalGetterSusu\Withdrawal\SusuServiceGoalGetterSusuWithdrawalFullData;
use App\Services\Susu\Requests\GoalGetterSusu\Withdrawal\SusuServiceGoalGetterSusuWithdrawalFullRequest;
...
final class GoalGetterSusuWithdrawalFullAcceptedTermsAction
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        // Execute the SusuServiceGoalGetterSusuWithdrawalFullRequest HTTP request and return the response
        $response = (new SusuServiceGoalGetterSusuWithdrawalFullRequest)->execute(customer: $customer, data: SusuServiceGoalGetterSusuWithdrawalFullData::toArray(user_inputs: $user_inputs), susu_resource: data_get(target: $user_inputs, key: 'susu_account.attributes.resource_id'));
