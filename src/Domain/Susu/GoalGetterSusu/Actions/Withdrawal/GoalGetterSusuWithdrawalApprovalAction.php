...
use App\Services\Susu\Data\GoalGetterSusu\Withdrawal\SusuServiceGoalGetterSusuWithdrawalCancellationData;
...
final class GoalGetterSusuWithdrawalApprovalAction
{
    ...
    {
        // Execute the SusuServiceGoalGetterSusuWithdrawalApprovalRequest and return the response
        $response = (new SusuServiceGoalGetterSusuWithdrawalApprovalRequest)->execute(
    ...
    {
        // Execute the SusuServiceGoalGetterSusuWithdrawalCancellationRequest HTTP request
        $response = (new SusuServiceGoalGetterSusuWithdrawalCancellationRequest)->execute(
            customer: $session->customer,
            data: SusuServiceGoalGetterSusuWithdrawalCancellationData::toArray(),
            susu_resource: data_get(target: $session->userInputs(), key: 'susu_account.attributes.resource_id'),
            withdrawal_resource: data_get(target: $session->userInputs(), key: 'withdrawal_resource'),
        );
