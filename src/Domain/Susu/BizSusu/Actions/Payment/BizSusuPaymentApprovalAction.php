...
use App\Services\Susu\Data\BizSusu\Payment\SusuServiceBizSusuPaymentCancellationData;
...
final class BizSusuPaymentApprovalAction
{
    ...
    {
        // Execute the SusuServiceBizSusuPaymentApprovalRequest and return the response
        $response = (new SusuServiceBizSusuPaymentApprovalRequest)->execute(
    ...
    {
        // Execute the SusuServiceBizSusuPaymentCancellationRequest HTTP request
        $response = (new SusuServiceBizSusuPaymentCancellationRequest)->execute(
            customer: $session->customer,
            data: SusuServiceBizSusuPaymentCancellationData::toArray(),
            susu_resource: data_get(target: $session->userInputs(), key: 'susu_account.attributes.resource_id'),
            payment_resource: data_get(target: $session->userInputs(), key: 'payment_resource'),
        );
