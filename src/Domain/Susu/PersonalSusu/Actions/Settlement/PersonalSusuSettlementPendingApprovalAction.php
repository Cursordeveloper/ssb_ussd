...
use App\Services\Susu\Requests\PersonalSusu\Settlement\SusuServicePersonalSusuSettlementPendingApprovalRequest;
...
final class PersonalSusuSettlementPendingApprovalAction
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        $balance = (new SusuServicePersonalSusuSettlementPendingApprovalRequest)->execute(
            customer: $customer,
