...
use App\Services\Susu\Requests\PersonalSusu\Pause\SusuServicePersonalSusuCollectionPauseApprovalRequest;
...
final class PersonalSusuCollectionPauseApprovalAction
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        $balance = (new SusuServicePersonalSusuCollectionPauseApprovalRequest)->execute(
            customer: $customer,
