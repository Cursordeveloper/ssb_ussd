...
final class FlexySusuPaymentAmountAcceptedTermsAction
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        // Execute the SusuServiceFlexySusuPaymentAmountRequest HTTP request and return the response
        $response = (new SusuServiceFlexySusuPaymentAmountRequest)->execute(customer: $customer, data: SusuServiceFlexySusuPaymentAmountData::toArray(user_inputs: $user_inputs), susu_resource: data_get(target: $user_inputs, key: 'susu_account.attributes.resource_id'));
