...
final class FlexySusuPaymentAmountAcceptedTermsAction
{
    ...
    {
        // Execute the SusuServiceFlexySusuPaymentAmountRequest HTTP request
        $response = (new SusuServiceFlexySusuPaymentAmountRequest)->execute(
            customer: $session->customer,
            data: SusuServiceFlexySusuPaymentAmountData::toArray(user_inputs: $session->userInputs()),
