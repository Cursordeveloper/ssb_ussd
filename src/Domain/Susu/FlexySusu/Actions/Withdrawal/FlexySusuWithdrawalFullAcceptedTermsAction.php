...
final class FlexySusuWithdrawalFullAcceptedTermsAction
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        // Execute the SusuServiceFlexySusuWithdrawalFullRequest HTTP request and return the response
        $response = (new SusuServiceFlexySusuWithdrawalFullRequest)->execute(customer: $customer, data: SusuServiceFlexySusuWithdrawalFullData::toArray(user_inputs: $user_inputs), susu_resource: data_get(target: $user_inputs, key: 'susu_account.attributes.resource_id'));
