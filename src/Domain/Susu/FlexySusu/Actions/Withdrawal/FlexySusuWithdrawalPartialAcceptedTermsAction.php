...
final class FlexySusuWithdrawalPartialAcceptedTermsAction
{
    ...
    {
        // Execute the SusuServiceFlexySusuWithdrawalPartialRequest HTTP request
        $response = (new SusuServiceFlexySusuWithdrawalPartialRequest)->execute(
            customer: $session->customer,
            data: SusuServiceFlexySusuWithdrawalPartialData::toArray(user_inputs: $session->userInputs()),
