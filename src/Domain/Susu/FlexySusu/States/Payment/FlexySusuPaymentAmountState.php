...
final class FlexySusuPaymentAmountState
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        return match (true) {
            ! array_key_exists(key: 'amount', array: $user_inputs) => BizSusuPaymentAmountAction::execute(session: $session, session_data: $session_data),
            ! array_key_exists(key: 'accepted_terms', array: $user_inputs) => BizSusuPaymentAmountAcceptedTermsAction::execute(session: $session, session_data: $session_data),
