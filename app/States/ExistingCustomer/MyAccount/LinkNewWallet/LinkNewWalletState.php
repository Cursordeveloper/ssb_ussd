...
use Domain\ExistingCustomer\Actions\MyAccount\LinkNewWallet\LinkNewAction;
...
final class LinkNewWalletState
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        return match (true) {
            ! array_key_exists(key: 'link_wallet', array: $user_inputs) => LinkNewAction::execute(session: $session, session_data: $session_data),
