...
namespace App\States\ExistingCustomer\Loans\AboutLoans\LoanQualification;
...
final class AboutLoanQualificationState
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        if ($session_data->user_input === '#') {
            ...
            return LoanQualificationMenu::nextContentMenu(session: $session);
        }

        // Return the invalidChoiceMenu
        return LoanQualificationMenu::invalidChoiceMenu(session: $session);
    }
}
