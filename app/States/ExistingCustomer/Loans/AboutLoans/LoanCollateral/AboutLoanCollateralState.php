...
namespace App\States\ExistingCustomer\Loans\AboutLoans\LoanCollateral;
...
final class AboutLoanCollateralState
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        if ($session_data->user_input === '#') {
            ...
            return LoanCollateralMenu::nextContentMenu(session: $session);
        }

        // Return the invalidChoiceMenu
        return LoanCollateralMenu::invalidChoiceMenu(session: $session);
    }
}
