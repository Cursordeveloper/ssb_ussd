...
namespace App\States\ExistingCustomer\Loans\AboutLoans\LoanRepayments;
...
final class AboutLoanRepaymentsState
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        if ($session_data->user_input === '#') {
            ...
            return LoanRepaymentsMenu::nextContentMenu(session: $session);
        }

        // Return the invalidChoiceMenu
        return LoanRepaymentsMenu::invalidChoiceMenu(session: $session);
    }
}
