...
namespace App\States\ExistingCustomer\Pension\AboutPension\AboutPensionCommissions;
...
final class AboutPensionCommissionsState
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        if ($session_data->user_input === '#') {
            ...
            return AboutPensionCommissionsMenu::nextContentMenu(session: $session);
        }

        // Return the invalidChoiceMenu
        return AboutPensionCommissionsMenu::invalidChoiceMenu(session: $session);
    }
}
