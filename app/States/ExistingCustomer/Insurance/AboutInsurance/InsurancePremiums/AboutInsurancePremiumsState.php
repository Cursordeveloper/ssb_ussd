...
namespace App\States\ExistingCustomer\Insurance\AboutInsurance\InsurancePremiums;
...
final class AboutInsurancePremiumsState
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        if ($session_data->user_input === '#') {
            ...
            return InsurancePremiumsMenu::nextContentMenu(session: $session);
        }

        // Return the invalidChoiceMenu
        return InsurancePremiumsMenu::invalidChoiceMenu(session: $session);
    }
}
