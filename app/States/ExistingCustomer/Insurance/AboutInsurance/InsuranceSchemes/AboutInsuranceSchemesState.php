...
namespace App\States\ExistingCustomer\Insurance\AboutInsurance\InsuranceSchemes;
...
final class AboutInsuranceSchemesState
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        if ($session_data->user_input === '#') {
            ...
            return InsuranceSchemesMenu::nextContentMenu(session: $session);
        }

        // Return the invalidChoiceMenu
        return InsuranceSchemesMenu::invalidChoiceMenu(session: $session);
    }
}
