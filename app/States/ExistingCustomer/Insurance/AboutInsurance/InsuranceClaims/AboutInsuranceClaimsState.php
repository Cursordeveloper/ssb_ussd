...
namespace App\States\ExistingCustomer\Insurance\AboutInsurance\InsuranceClaims;
...
final class AboutInsuranceClaimsState
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        if ($session_data->user_input === '#') {
            ...
            return InsuranceClaimsMenu::nextContentMenu(session: $session);
        }

        // Return the invalidChoiceMenu
        return InsuranceClaimsMenu::invalidChoiceMenu(session: $session);
    }
}
