...
final class SusuAccountState
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        $stateMappings = [
            ...
            '4' => ['class' => new SusuMiniStatementState, 'menu' => new SusuMiniStatementMenu],
            '5' => ['class' => new PersonalSusuCollectionPauseState, 'menu' => new PersonalSusuCollectionPauseMenu],
