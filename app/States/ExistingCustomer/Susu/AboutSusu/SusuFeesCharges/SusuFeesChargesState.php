...
namespace App\States\ExistingCustomer\Susu\AboutSusu\SusuFeesCharges;
...
final class SusuFeesChargesState
{
    public static function execute(Session $session, $session_data): JsonResponse
    {
        ...
        if ($session_data->user_input === '#') {
            ...
            return SusuFeesChargesMenu::nextContentMenu(session: $session);
        }
