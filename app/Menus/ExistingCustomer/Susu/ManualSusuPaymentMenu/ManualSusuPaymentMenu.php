...
namespace App\Menus\ExistingCustomer\Susu\ManualSusuPaymentMenu;

use App\Common\Helpers;
use App\Common\ResponseBuilder;
use Symfony\Component\HttpFoundation\JsonResponse;

final class ManualSusuPaymentMenu
{
    ...
    public static function totalValueMenu($session, string $frequency): JsonResponse
    {
        $frequencies = ['daily' => 'day', 'weekly' => 'week', 'monthly' => 'month'];

        // Prepare and return the narration
        return ResponseBuilder::ussdResourcesResponseBuilder(
            message: 'Enter '.$frequencies[strtolower($frequency)].'(s) to pay:',
            session_id: $session->session_id,
        );
    }
