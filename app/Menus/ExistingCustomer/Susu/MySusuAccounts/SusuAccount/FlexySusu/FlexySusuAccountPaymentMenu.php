...
namespace App\Menus\ExistingCustomer\Susu\MySusuAccounts\SusuAccount\FlexySusu;

use App\Common\ResponseBuilder;
use Domain\Shared\Models\Session\Session;
use Symfony\Component\HttpFoundation\JsonResponse;

final class FlexySusuAccountPaymentMenu
{
    public static function mainMenu(Session $session): JsonResponse
    {
        ...
        return ResponseBuilder::ussdResourcesResponseBuilder(
            message: 'How many '.$frequencies[data_get(target: $user_inputs, key: 'susu_account.frequency')].'?',
