...
final class CreateBizSusuMenu
{
    ...
    {
        return ResponseBuilder::ussdResourcesResponseBuilder(
            message: 'Account name: '.$susu_data['business_name'].'. Susu amount: '.$susu_data['amount'].'. Debit Frequency: '.strtolower($susu_data['frequency']).' Wallet '.$susu_data['linked_wallet'].'. Enter pin to confirm or 2 to Cancel.',
            session_id: $session->session_id,
        );
    }
}
